               ...
               <!--User Profile Table-->
               	<div class="chart tab-pane active" id="revenue-chart" style="position: relative; height: 700px;">
				   	...
				   	{	  
						...
						<center><table>
						<tr><td>Username:</td><td><input type="text" class="" name="username" placeholder="Username" value="<?php echo $_SESSION['username']; ?>"autocomplete="off" size="40" readonly /></td></tr>
						<tr><td>Password:</td><td><input type="text" class="" name="password" value="<?php echo $_SESSION['password']; ?>" autocomplete="off" size="40"/></td></tr>
						<tr><td>Password Hint:</td><td><input type="text" class="" name="password_hint" value="<?php echo $_SESSION['password_hint']; ?>" autocomplete="off" size="40"/></td></tr>	
						<tr><td>Email:</td><td><input type="email" class="" name="email" value="<?php echo $_SESSION['email']; ?>" autocomplete="off" size="40"/></td></tr>						
						<tr><td>Employee Name:</td><td><input type="text" class="" name="employeename" value="<?php echo $_SESSION['employeename']; ?>" autocomplete="off" size="40" /></td></tr>
						<tr><td>Employee ID:</td><td><input type="text" class="" name="employee_id" value="<?php echo $_SESSION['employee_id']; ?>"  autocomplete="off" size="40"/></td></tr>
						<tr><td>Position:</td><td><input type="text" class="" name="position" value="<?php echo $_SESSION['position']; ?>"autocomplete="off" size="40"/></td></tr>
                  <tr><td>Delivery Team:</td><td><input type="text" class="" name="delivery_team" value="<?php echo $_SESSION['delivery_team']; ?>"autocomplete="off" size="40"/></td></tr>
						<tr><td>Functional Group:</td><td><input type="text" class="" name="functional_group" value="<?php echo $_SESSION['functional_group']; ?>"autocomplete="off" size="40"/></td></tr>
                  <tr><td>User Type:</td><td> <input type="text" class="" name="user_type" value="<?php echo $_SESSION['user_type']; ?>"autocomplete="off" size="40" readonly /></td></tr>	
						<tr><td>Additional Details:</td><td> <input type="text" class="" name="additional_details" value="<?php echo $_SESSION['additional_details']; ?>"autocomplete="off" size="40" readonly /></td></tr>	
						<tr><td>Account Status:</td><td> <input type="text" class="" name="account_status" value="<?php echo $_SESSION['account_status']; ?>"autocomplete="off" size="40" readonly /></td></tr>	
						</table></center>
						</br>
						</br>
