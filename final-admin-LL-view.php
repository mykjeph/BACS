	...
	//mysqli_close($conn);
		...
		//==========Upload Before Photo==========	
			if(!empty($_FILES['before_attachment']['name']))
			{
    			...
    			{
        			echo "\r\n Your file extension must be .jpg or .png";
    			} 				
               ...
               <i class="right fas fa-angle-left"></i>
            		...
            		<ul class="nav nav-treeview">
                  	...
                  	<p>Manage LLs</p>
							...
							<li class="nav-item">              				
              			<a href="final-admin-LL-view.php" class="nav-link  active">
                  	<i class="far fa-circle nav-icon"></i>
                  	<p>View All LLs</p>
                		</a>
              			</li>	
         	...
         	<li class="nav-item has-treeview menu-close">
               ...
               <i class="right fas fa-angle-left"></i>
						...
						<ul class="nav nav-treeview">
                  		...
                  		<i class="far fa-circle nav-icon"></i>
                  		<p>Customize LL Document Report</p>
                			</a>
              			</li>					  
            		</ul>
          	</li>  
...
?>
	...
	<!--/.Modal-->
      ...
      <div class="container-fluid">
      	<div class="row mb-2">
         	<div class="col-sm-6">
            <h1 class="m-0 text-dark"> View/Update Lessons Learned Documents </h1>
          	</div><!--/.col-->
            ...
            <form class="text-center border border-light p-5" name="form" method="post" action=""> 				
				...
				?>	
					<!--<?php
						...
						{
						$dataholder=$_SESSION['dataholder'];
						$test=strval('attachments/'.$dataholder.'/*');
						$files = glob($test . "*.{jpg,gif,png,txt,pdf}", GLOB_BRACE);
				...
				<?php }?>
              	...
              	<form  class="text-right border border-light p-4" name="form" method="post" action="" enctype="multipart/form-data">
		 			<input name="btn-update_ll" style="margin:3px;" class="btn btn-primary" type="submit" value="Update" />
					<!--<input name="btn-delete" class="btn btn-primary" type="submit" value="Delete Photos" />-->
					</br>
					</br>
					...
					<tr><td>Delivery Team: </td><td>  <input type="text" name="delivery_team" value="<?php echo  $_SESSION['delivery_team'] ;?>" placeholder="" size="60" autocomplete="off"/></td></tr>
					<tr><td>Location: </td><td>  <input type="text" name="location" value="<?php echo  $_SESSION['location'] ;?>" placeholder="" size="60"  autocomplete="off"/></td></tr>
					<tr><td>Date Issued: </td><td>  <input type="text" name="date_issued" value="<?php echo  $_SESSION['date_issued'] ;?>" placeholder=""  size="60"  autocomplete="off"/></td></tr>
					...
					<tr><td>Submitted by: </td><td><input type="text" name="submitted_by" value="<?php echo  $_SESSION['submitted_by'] ;?>" placeholder="" size="60" autocomplete="off"/></td></tr>
