         	...
         	<li class="nav-item has-treeview menu-close">
               ...
               <i class="right fas fa-angle-left"></i>
            		...
            		<ul class="nav nav-treeview">
              			<li class="nav-item">
                		<a href="reviewer-LL-view.php" class="nav-link ">
         ...
         <!--Add icons to the links using the .nav-icon class with font-awesome or any other icon font library-->
         	<li class="nav-item has-treeview menu-open">
               ...
               <i class="right fas fa-angle-left"></i>
            	...
            	<ul class="nav nav-treeview">
			 			<li class="nav-item">
                	<a href="review-profile.php" class="nav-link  active ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>My Profile</p>
                	</a>
              		</li>		  	  
     		...
     		<div class="chart tab-pane active" id="revenue-chart" style="position: relative; height: 700px;">
						<?php
				 		...
				 		if(isset($_POST["btn-update"]))
				  			...
				  			{
								echo "No function selected."; //Error Handler					  
				  			}	
						?>
