...
if(isset($_POST["btn-update"])){ 
	...
	{  
			...
			echo 'alert("The Document No. you have entered does not exist!")';
			echo '</script>';		
	}	
	mysqli_close($conn);
	}	
...
if(isset($_POST["get_doc_no"])){ 
	$document_no=trim($_POST['get_doc_no']);	
	...
	function updatelldocument()
	{
		...
		$loguser=$_SESSION["loguser"];
		$updocument_no=$_POST['document_no1'];
		$updocument_status=$_POST['updocument_status'];
		...
		$upbefore_attachment=$_FILES['before_attachment']['name'];
		$upafter_attachment=$_FILES['after_attachment']['name'];			
	...
	//mysqli_close($conn);
					echo '<script language="javascript">';
					echo 'alert("LL Document has been updated successfully.")';
					echo '</script>';
			...
			//==========Upload Before Photo==========	
			if(!empty($_FILES['before_attachment']['name']))
			{
				$dir = $updocument_no;				
    		...
    		else 
    			{
        			...
        			{
            		$sql = "UPDATE ll SET before_attachment='$filename_before' WHERE document_no='$updocument_no'";
			...
			//==========Upload After Photo==========
			if(!empty($_FILES['after_attachment']['name']))
			{
				$dir = $updocument_no;				
    			...
    			else 
    			{
        			...
        			{         				
            		$sql2 = "UPDATE ll SET after_attachment='$filename_after' WHERE document_no='$updocument_no'";
            ...
            <i class="right fas fa-angle-left"></i>
            	...
            	<ul class="nav nav-treeview">
                  ...
                  <p>Create New LL</p>
						...
						<li class="nav-item">
                	<a href="final-user-view_ll.php" class="nav-link  active">
                  <i class="far fa-circle nav-icon"></i>
...
<?php				
		if (isset($_POST['submitemail']))
	{
		...
		move_uploaded_file($_FILES["docu"]["tmp_name"], $path);
					...
					<p>Printed documents can become obsolete, please <a href="http://3.21.91.216/BACS/all-login.php">log in</a> to your account for the latest LL Document copy.</p>
					</br>				
					';
...
?>
	...
	<!--Content Wrapper. Contains Page Content-->
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">View/Update Submitted Lessons Learned Documents </h1>
          </div><!--/.col-->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="user-profile.php">LL User</a></li>
              <li class="breadcrumb-item active">Manage Submitted LLs</li>
            </ol>
          </div><!--/.col-->
        </div><!--/.row-->
      </div><!--/.container-fluid-->
      	...
      	<div class="row">        
            ...
            <div class="card-body">
			   <!--<form class="text-center border border-light p-5" name="form" method="post" action=""> 				
				<p>Enter LL Document No.: <input type="text" name="document_no" placeholder="" size = "30"  autocomplete="off" required  />			
				...
				<br>
				<br>
				<div id="printTable2" style="position:relative;height:700px;overflow-y: scroll;">
				<?php
				...
				<?php
						...
						$query="";
						$query=$conn->query("select * from ll where submitted_by = '$loguser' and document_status = 'Open' or submitted_by = '$loguser' and document_status = 'Rolled back'");
						$results = array();		
				...
				<a id="btnSubmit" href="#"><img width="30" style="vertical-align:middle;margin:5px" src="image/printlogo.png" title="Print"></a></div>
			
					<form class="text-right border border-light p-4" name="form" method="post" action="" enctype="multipart/form-data"> 
					<input name="btn-updatell" class="btn btn-primary" type="submit" value="Update" />
					</br>
					</br>
					...
					<tr><td></td><td><input type="hidden" name="updocument_status" value="Open"placeholder="" size="60" readonly/></td></tr>
					...
					<tr><td>Date Issued: </td><td><input type="text" name="date_issued" value="<?php echo  $_SESSION['date_issued'] ;?>" placeholder="" size="60" readonly/></td></tr>
					...
					<tr><td>Submitted by: </td><td><input type="text" name="submitted_by" value="<?php echo  $_SESSION['submitted_by'] ;?>" placeholder="" size="60" readonly/></td></tr>
					...
					<tr><td>Comment: </td><td><input type="text" name="comment" value="" placeholder="" size="60" autocomplete="off"/></td></tr>					
							
					</form>
					<tr><td></br></td></tr>						
					<tr><td><h5 style="text-align:left!important;">References Photos:</h5></td>
					<td>
					...
					<input type="file" name="before_attachment" id="" value="<?php echo $_SESSION['before_attachment']?>"/></td></tr>
						
					<tr><td>After Photo:</td><td>
					<input type="file" name="after_attachment" id="" value="<?php echo $_SESSION['after_attachment']?>"/></td></tr>	
